...
1.  **Receive Initial Prompt:** The user has provided a brief description/request for a new feature or functionality in the $ARGUMENTS file.
...
- These questions should be asked in the form of a "prd-survey.md" and the assumed/best-guess answer should be prepopulated for each qestion.

3.  **Generate PRD:** Based on the initial prompt and the user's answers to the clarifying questions, generate a PRD using the structure outlined below.
4.  **Save PRD:** Save the generated document as `prd-[feature-name].md` inside the `/planning` directory.
